                ...
                if($EMPLOYMENTSTATUS=='AGENCY-GSL' || $EMPLOYMENTSTATUS=='PASECA' || $EMPLOYMENTSTATUS=='MAKABAYAN' || $EMPLOYMENTSTATUS=='CROWN')
                {
                  ...
                  $sqlDTR = "select 
                    ...
                    END is null,0,datediff(minute,BREAKOUT, BREAKIN)) AS BREAK
                      FROM POSTTK 
                      where DATESCAN BETWEEN '".$dday."' AND  (SELECT tblcutoff_ref.FLDCUTOFFDATE from tblcutoff_ref WHERE tblcutoff_ref.FLDCOMPANY='AGENCY') and EMPID='".$id." ' 
                ...
                else
                {
                  $sqlDTR = "select 
                    ...
                    END is null,0,datediff(minute,BREAKOUT, BREAKIN)) AS BREAK
                      ...
                      FROM POSTTK 
                      where DATESCAN BETWEEN '".$dday."' AND  (SELECT tblcutoff_ref.FLDCUTOFFDATE from tblcutoff_ref WHERE tblcutoff_ref.FLDCOMPANY='DSG') and EMPID='".$id." ' 
                      ORDER BY DATESCAN ASC";
                }
                //echo $sqlDTR;
                $total_HWPD = "";
                    ...
                    $WHOLE = "";
                     ...
                     //{
                       ...
                       //LATE
                        ...
                        //CHECK IF OUTPM IS GREATER THAN THE OFFICIAL DAILY OUT REF
                        if ($INAM != null && $OUTAM != null && $INPM != null && $OUTPM != null ) {
                           $OUTPMRef = $dateformatINAM. ' ' . $MONDAYINREF;
                           $WHOLEDAY_UNDERTIME = round((strtotime($OUTPM) - strtotime($OUTPMRef)) /60);
                        }                     
